...
<body>
	<ul class="nav nav-tabs">
		...
		<shiro:hasPermission name="charge:deductionDoc:edit"><li><a href="${ctx}/charge/deductionDoc/form">抵扣项文件添加</a></li></shiro:hasPermission>
	</ul>
	...
	<table id="contentTable" class="table table-striped table-bordered table-condensed">
		<thead>
			<tr>
				...
				<th>更新时间</th>
				<th>备注信息</th>
				<shiro:hasPermission name="charge:deductionDoc:edit"><th>操作</th></shiro:hasPermission>
			</tr>
		</thead>
		<tbody>
		<c:forEach items="${page.list}" var="deductionDoc">
			<tr>
				...
				<shiro:hasPermission name="charge:deductionDoc:edit"><td>
