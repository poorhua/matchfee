...
<body>
	<ul class="nav nav-tabs">
		...
		<li class="active"><a href="${ctx}/charge/deductionDoc/form?id=${deductionDoc.id}">抵扣项文件<shiro:hasPermission name="charge:deductionDoc:edit">${not empty deductionDoc.id?'修改':'添加'}</shiro:hasPermission><shiro:lacksPermission name="charge:deductionDoc:edit">查看</shiro:lacksPermission></a></li>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="deductionDoc" action="${ctx}/charge/deductionDoc/save" method="post" class="form-horizontal">
		...
		<div class="form-actions">
			<shiro:hasPermission name="charge:deductionDoc:edit"><input id="btnSubmit" class="btn btn-primary" type="submit" value="保 存"/>&nbsp;</shiro:hasPermission>
