 ...
 */
package org.wxjs.matchfee.modules.creadit.web;
...
import org.wxjs.matchfee.modules.creadit.service.TchecklistService;
 ...
 */
@Controller
@RequestMapping(value = "${adminPath}/creadit/tchecklist")
public class TchecklistController extends BaseController {
	...
	@RequiresPermissions("creadit:tchecklist:view")
	...
	public String list(Tchecklist tchecklist, HttpServletRequest request, HttpServletResponse response, Model model) {
		...
		return "modules/creadit/tchecklistList";
	}
	...
	public String form(Tchecklist tchecklist, Model model) {
		...
		return "modules/creadit/tchecklistForm";
	}

	@RequiresPermissions("creadit:tchecklist:edit")
	...
	public String save(Tchecklist tchecklist, Model model, RedirectAttributes redirectAttributes) {
		...
		return "redirect:"+Global.getAdminPath()+"/creadit/tchecklist/?repage";
	}
