 ...
 */
package org.wxjs.matchfee.modules.act.service.ext;
...
//		}
		...
		if (user != null) {
			getSystemService().deleteUser(new org.wxjs.matchfee.modules.sys.entity.User(user.getId()));
		}
	}
...
//		return getDbSqlSession().selectList("selectGroupsByUserId", userId);
		...
		for (Role role : getSystemService().findRole(new Role(new org.wxjs.matchfee.modules.sys.entity.User(null, userId)))){
